...
const api = adminResource("testimonials");
...
export default function AdminTestimonials() {
  ...
  const openEdit = (t) => { setForm(t); setEditId(t.id); setView("form"); };
  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {items.map((t) => (
          <div key={t.id} className="bg-white rounded-xl p-5 shadow-sm flex flex-col gap-3">
            <div>
