...
const api = adminResource("projects");

const empty = {
  order: "", title: "", category: "", tagline: "",
...
export default function AdminProjects() {
  ...
  const openEdit = (p) => { setForm({ ...p, techStack: (p.techStack || []).join(", ") }); setEditId(p.id); setView("form"); };
